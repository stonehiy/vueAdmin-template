...
<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit
      ...
      <el-table-column align="center" min-width="100px" label="登录名" prop="username">
      </el-table-column>

      <el-table-column align="center" min-width="100px" label="手机号码" prop="phoneNumber">
      </el-table-column>

      <el-table-column align="center" min-width="50px" label="用户名" prop="name">
      </el-table-column>
...
<script>
  import {getUserList, getUserById, addUser, updateUser, deleteAuthClient} from '@/api/user'
